...
project_id = 'absolute-cache-409313'
dataset_name = 'v_mart_user_details'
table_name = 'user_data'

# Keep track of email to user ID mapping
email_to_user_id = {}
...
def generate_user_id(email: str) -> str:
    if email is not None:
        ...
        if email in email_to_user_id:
            ...
            # Generate a new user ID and store the mapping
...
def create_bigquery_table(project_id: str, dataset_id: str, table_id: str) -> None:
    ...
    try:
        ...
        schema = [
            bigquery.SchemaField("user_id", "STRING"),  # Change to STRING for UUID
        ...
        bigquery_client.create_table(table_name)
...
def upload() -> str:
    ...
    if request.method == 'POST':
        ...
        status = save_user_details(user_id, user_email, user_name, uploaded_file.filename, timestamp)
...
def save_user_details(user_id: str, user_email: str, user_name: str, filename: str, timestamp: str) -> str:
